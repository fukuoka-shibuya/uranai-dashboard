...
(function (root, factory) {
  ...
  var KANSHI_YOMI = {
    ...
    year: {
      ...
      '戊辰': '戊辰は、厚い土手が、春を送り夏を迎える境目に横たわる形で、外から見えるのはその厚みです。慌てないので、周りには大柄で頼れる人という印象が残りやすいようです。話がまとまらず時間だけが過ぎるときに、その重さが役に立ちます。長い話し合いの終わりに、決まった事だけを読み上げて場を閉じます。素早い返しを求められる持ち場では、逆に鈍い人と思われます。中身は後でも返事だけ先に短く返すほうが、重さが値打ちになると見ます。',
      ...
      '庚午': '庚午が外へ見せているのは、打ち鍛えた地金が、日の長い盛りの熱で焼きを受ける、その硬さです。物言いが濁らないため、人からははっきりした強い人と見られます。誰も切り出さない話が居座っているときに、その硬さが表へ出ます。皆が黙っている不都合を、会の席で先に名指しして片づけます。全員の気持ちをそろえたい場では、逆に角の立つ人と見なされそうです。切り出す前に相手の言い分を一度なぞるほうが、同じ話でも通ると見ます。',
      ...
      '壬申': '前例のない相談が持ち込まれたときにいちばん強く出るのが壬申です。川筋の水が、刈り入れの入り口で形の決まった器へ流れ込む並びにあたります。切り替えが速いので、人からは話の早い人と受け取られます。誰も答えを持たない問い合わせに、その場で二つ三つの道筋を出してみせます。同じ決まりを守り続ける役では、逆に腰の据わらない人と見られます。守る回と考える回を分けて引き受けるのが向いていると見ます。',
      '癸酉': '癸酉という並び方は、霧のような雨が、取り入れのさなかの澄んだ空から降る形にあたります。物音を立てないぶん、周りには控えめでよく気のつく人と映ります。人の見落としが表沙汰になるところで、その働きが分かります。数の合わない箇所を騒がずに直しておく、といったときです。勢いで押し切る場では、逆に気の弱い人と扱われることもありそうです。気づいた点を一つだけ声に出して渡すほうが、正しく届くと見ます。',
      '甲戌': '甲戌は、立木が、秋を畳むころの締まった土へまっすぐ根を下ろす形で、外から見えるのはその真っすぐさです。約束の扱いが変わらないので、周りには堅い人だという評判が立ちやすいようです。話が曖昧に流れかけたときに、その堅さが頼りにされます。皆が言葉を濁し始めた席で、初めの取り決めを声に出して読み直します。融通の利く駆け引きが要る場では、逆に窮屈な人と思われます。譲れる幅を一つ先に示すのが向いていると見ます。',
      ...
      '己卯': '己卯は、畝を整えた畑地が、草木の勢いづく時節に若い芽を抱える形で、外から見えるのはその手の出しようです。放っておけないので、周りには世話焼きな人と映ります。誰かが伸びかけているところで、その細やかさが働きます。飲み込みの遅い相手にも、言い方を三度取り替えて付き合います。急いで結果を出したい場では、逆に手数の多すぎる人と扱われやすいようです。待つ期限を自分の中で決めるほうが、押しつけにならないと見ます。',
      '庚辰': '庚辰を人がどう眺めるかというと、打ち鍛えた地金が、春を送り夏を迎える境目の厚い土に据わる、その頼もしさです。重さに慣れているため、人からは大仕事を任せられる人と見られます。引き受け手のいない役が回ってきた時期に、その評価が固まります。年をまたぐ当番を、途中で降りずに務め上げます。細かい用事を素早くさばく場では、逆に小回りの利かない人と受け取られやすいようです。持てる荷の大きさを自分から申し出るほうが、力が生きると見ます。',
      ...
      '癸未': '誰かが言い出せずにいるところでいちばん強く出るのが癸未です。霧のような雨が、熱の引きぎわの乾いた土へしみ込む並びにあたります。乾きに先に気づくので、周りには察しのよい人と映ります。席の端で黙っている人へ先に近づき、用向きを引き出します。自分の取り分を主張すべき席では、逆に押しの弱い人と見なされそうです。自分の取り分を一つ先に決めておくほうが、無理なく続くと見ます。',
      ...
      '戊子': '込み入った相談が持ち込まれるところでいちばん強く出るのが戊子です。厚い土手が、寒の底の水を黙って受け止める並びにあたります。動じない構えなので、人からは何を話しても大丈夫な人と見られます。返事を急がず、相手が話し終わるまで口を挟まない様子がそう見せます。自分の弱りを見せるべきときには、逆に隙のない人と映ります。こちらの困りごとを先に一つ打ち明けるほうが、間合いが近くなると見ます。',
      '己丑': '己丑という並び方は、耕された畑地が、冬を送るころの土と重なる形にあたります。飾りが無いぶん、周りには動かない人だと映ります。誰も見ていない下ごしらえが続く時期に、その値打ちが表れます。同じ帳面を毎日同じ形でつけ、当番を十年欠かしません。目新しさで競う場では、逆に古びた人と扱われやすいようです。続けた量を一度だけ数で示すほうが、正しく伝わると見ます。',
      ...
      '辛卯': '辛卯を人がどう眺めるかというと、細身の刃が、草木の勢いづく時節に枝ぶりを整える、その手つきです。乱れを見過ごせないので、周りには筋を通す人と映ります。散らかったものを一枚にまとめるところで、その手際が見えます。会の控えを読みやすい順に並べ替えて配ります。粗いまま走り出す立ち上がりでは、逆に細かすぎる人と受け取られやすいようです。まず一度動かしてから直す順にするほうが、良さが生きると見ます。',
      '壬辰': '壬辰が外へ見せているのは、豊かな水が、春を送り夏を迎える境目の厚い土に受け止められる、その落ち着きです。大きく動いても踏み外さないので、人からは任せて安心な人と見られます。話の揺れる時期に、その舵取りが目に留まります。値の振れた月にも持ち高を動かさず、うまい話を一つ見送ります。小さくまとめて終わる仕事ばかりでは、逆に鈍い人と見なされそうです。揺れの大きい一件を自分から引き受けるほうが、持ち味が出ると見ます。',
      ...
      '乙未': '乙未という並び方は、やわらかい草が、熱の引きぎわの乾いた土に根を張る形にあたります。角が立たないので、周りには当たりの柔らかい人と映ります。条件の厳しい持ち場が続く時期に、その粘りが見えてきます。予算も人手も足りないまま、それでも回し続けています。早く白黒を決めたい場では、逆に煮え切らない人と扱われることもありそうです。断る一言を先に用意しておくのが向いていると見ます。',
      ...
      '庚子': '庚子という並び方は、鍛えた刃が、寒の底の水で冷やされる形にあたります。感情に流されないので、周りには理の勝った人と映ります。話が荒れたところで、その冷静さが際立ちます。感情の高ぶった場でも、事の前後だけを取り出して並べます。気持ちを汲むことが先に求められる席では、逆に冷たい人と見なされそうです。相手の言い分を一度受けてから口を開くのが向いていると見ます。',
      ...
      '乙巳': '正面から押し合わずに近づくところでいちばん強く出るのが乙巳です。細い草が、熱の上がりはじめる時節へ向けて伸びる並びにあたります。争わないので、周りには角の無い人と映ります。名乗りを上げないまま実績を積み、気づけば任されています。真正面の押し合いが要る席では、逆に煮え切らない人と受け取られやすいようです。ここぞの一度だけ正面から言うほうが、望みが早く届くと見ます。',
      ...
      '丁未': '丁未は、小さな灯が、熱の引きぎわの乾いた土をあたためる形で、外から見えるのは急かさない構えです。周りにはやさしい人と映り、待てる人だと言われやすいようです。手間のかかる相手との付き合いが長引く時期に、その良さが表れます。引き継ぎ書の無い持ち場を、前の人の癖ごと読み解いて回します。成果を数で競う場では、逆に手のかかる人と見なされそうです。人の名前が残る仕事を選ぶのが向いていると見ます。',
      '戊申': '戊申を人がどう眺めるかというと、厚い土が、刈り入れの入り口で研いだ刃を抱える、その腹の据わり方です。人からは決められる人と見られ、難しい役が回ってきます。人の進退を分けるところで、その姿がはっきり出ます。残る人と移る人を分けた結果を、間に人を挟まず自分の口で伝えます。和やかさを保ちたい集まりでは、逆に厳しい人と扱われることもありそうです。決めた理由を一言添えるほうが、後味がよくなると見ます。',
      '己酉': '己酉が外へ見せているのは、細かな土が、取り入れのさなかの澄んだ刃を包む、その隙のなさです。持ち物の扱いが整っているので、周りには預けて安心な人と映ります。細部を任されるところで、その正確さが評判になります。借りた物が期日どおり、借りたときと同じ姿で返ってくると皆が知っています。勢いだけで押し切りたい席では、逆に融通の利かない人と受け取られます。急ぐ相手には確かめたい点を先に一つ告げるほうが、待ってもらえると見ます。',
      ...
      '辛亥': '人が離れていくところでいちばん強く出るのが辛亥です。細い刃が、寒さの入り口の深い水に沈む並びにあたります。声高に語らないので、周りには一人が好きな人と映ります。皆が引き返した道を、一人で歩き通します。折り合いをつけて進める席では、逆に付き合いにくい人と扱われやすいようです。先に一人だけ話を通しておくほうが、筋が最後まで残ると見ます。',
      '壬子': '壬子は、大きな流れが、寒の底の水に重なる形で、外から見えるのはその底の知れなさです。軽く返さないので、周りには考え深い人と映ります。答えの出ない問いを扱うところで、その深さが頼りにされます。行く先を問うような相談を、何時間でも聞いていられます。明るく短く返す軽い付き合いでは、逆に重たい人と受け取られやすいようです。聞き役に回って一つ深く尋ねるほうが、持ち味が伝わると見ます。',
      '癸丑': '癸丑を人がどう眺めるかというと、しみ通る雨が、冬を送るころの固い土をゆるめる、その気の長さです。急かさないので、周りにはこじれを解ける人と映ります。間に入って時間をかけるところで、その働きが見えてきます。挨拶も交わさなくなった間柄へ、季節をまたいで通い直します。その場で決着を求められる席では、逆に頼りにならない人と見なされそうです。一晩置いて双方の言い分を聞くほうが、まとまりやすいと見ます。',
      ...
      '乙卯': '初めて会った相手が乙卯から受け取るのは、身のこなしの軽さです。やわらかい伸びやかさが、草木の勢いづく時節に重ねて出る並びだからでしょう。人の間を渡り歩くところで、周りはその軽やかさに頼ります。離れた輪にいる者どうしを引き合わせて回ります。一つの場に長く縛られる役では、逆に落ち着かない人と扱われることもありそうです。よそへ出入りする役目を持つのが向いていると見ます。',
      ...
      '戊午': '戊午は、厚い土が、日の長い盛りの熱を受けて動かない形で、外から見えるのはその広さです。真ん中に座っていられるので、人からは動じない人と見られます。要望が一度に飛んでくるところで、その厚みが働きます。窓口に座り続け、次々届く用件をさばいていきます。細かく段を踏んで進める仕事では、逆に抜けの多い人と扱われやすいようです。点検役を別に立てるほうが、大きさが値打ちになると見ます。',
      '己未': '己未を人がどう眺めるかというと、耕された畑地が、熱の引きぎわの乾いた土と重なる、その放っておけなさです。周りには面倒見のよい人と映り、人が寄ってきます。人が頼ってくるところで、その粘りが表れます。担当の決まっていない用事を黙って引き受け、場を回しています。取り分を口にすべき折になると、逆に遠慮が先に立つ人と受け取られやすいようです。自分の分け前をはじめに言い置くのが向いていると見ます。',
      '庚申': '庚申が外へ見せているのは、鍛えた金物が、刈り入れの入り口に重ねて置かれる、その容赦の無さです。無駄を残さないので、周りには手加減しない人と映ります。難しい判断が要るところで、その鋭さがはっきり出ます。膨れ上がった費用を半分にまで仕分けていきます。あいまいさを抱えて人を待つ席では、逆に急ぎすぎる人と見なされそうです。相手が自分で気づくまで一度だけ間を置くほうが、人が離れないと見ます。',
      ...
      '壬戌': '人や金を預かるところでいちばん強く出るのが壬戌です。大きな水が、秋を畳むころの締まった土に堰き止められる並びにあたります。踏み外さないので、人からは預けやすい人と見られます。他人の蓄えや人手をまとめて任され、減らさずに戻します。思い切って飛び出すべき時期には、逆に慎重すぎる人と扱われやすいようです。捨ててよい分だけを先に切り分けて動くほうが、機を逃さないと見ます。',
      '癸亥': '癸亥という並び方は、静かな雨が、寒さの入り口の深い水に重ねて降る形にあたります。汲み取りが細かいので、周りには気の回る人と映ります。言葉にならない用件を拾うところで、その細やかさが表れます。相手が言い出す前に、必要な物を先に用意しています。はっきりした線引きが要る席では、逆に頼りない人と受け取られやすいようです。自分の望みのほうを先に紙へ書き出すほうが、輪郭が戻ると見ます。'
    },
    month: {
  ...
  var KANSHI_ASSERT = [
    ...
    { name: '人柄に名を付けて言い切っている',
      re: /人(と|だと|だという)[^。]{0,14}(扱われます|留まります|評判が立ちます|言われ方をします|言われます|見なされます)。/ }
  ];
