...
(function (root, factory) {
  ...
  /* 総合占いは個別占術の文の再掲・連結にしない。中核5占術の「正式計算が出した結果値
     ...
     ただし10行のうち次の3行は、その値そのものの説明文が画面に無いため、別の文言からの
     読み替え・当てはめである(cycle-0043 の監査 M1 を受けて正直に明示する。台帳 OC43-L2):
      ...
      ・宿曜の動き出し:二十七宿の輪を三分した位置から写しており、対応する説明文が無い。
        区切り(0〜8/9〜17/18〜26)は SHUKU の並びを昴宿起点に置いた実装上の区分であって
        宿曜の教義に由来するものではない
     残る7行(算命学2・九星の動き出し・数秘の動き出し・西洋2・宿曜の間合い)は、
