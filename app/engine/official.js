...
(function (root, factory) {
  ...
  var KYUSEI_GETSUMEI_MAAI_NOTE = [
    ...
    'この星は、人と人の間に立って双方との近さを取り持ち直すとされています。',
    'この星は、輪の中心に置かれ、一人ひとりへ寄る前に場の全体を眺めるとされています。',
    'この星は、筋を保ったまま一定の隔たりを置いて人と向き合うとされています。',
    'この星は、和ませる言葉を交わしながら人と親しくなっていくとされています。',
    'この星は、時をかけて間合いを見定めてから人と関わるとされています。',
    'この星は、立つ場所が移るたびに人との近さも入れ替わるとされています。'
  ];
  ...
  var SUUHI_BIRTH_MAAI_NOTE = {
    1: '1という数は、人の輪の先頭に立ち、全体を見わたせる位置から人と関わらせるようです。',
    2: '2という数は、相手のすぐそばで受け答えする近さを好ませるようです。',
    3: '3という数は、人の輪へ自分から入り込んでいく近さを生むようです。',
    4: '4という数は、一定の隔たりを置いたまま人と向き合わせるようです。',
    5: '5という数は、場が替わるたびに人との近さを取り替えさせるようです。',
    6: '6という数は、身近な人の手元まで寄って世話を焼かせるようです。',
    7: '7という数は、一人になれる隔たりを残したまま人と関わらせるようです。',
    8: '8という数は、輪の外側から流れをつかむ位置に立たせるようです。',
    9: '9という数は、相手ごとに近さを描き分けながら広く関わらせるようです。',
    11: '11という数は、感じ取ったことをそのまま届けられる近さへ寄せるようです。',
    22: '22という数は、遠くまで見通せる場所から人と組み立てさせるようです。'
  };
  ...
  /* 総合占いは個別占術の文の再掲・連結にしない。中核5占術の「正式計算が出した結果値
     ...
     ここで正直に断っておく(cycle-0048 の監査 M1):写しの型そのものは据え置きで、
     月命星・誕生数の教義から引き直したわけではない。既存の型に合う一文を後から
     書き足し、画面の側から裏づけられる状態にした、というのが実態である。
     したがって「画面に根拠がある」は満たしたが、「型が文から導かれた」わけではない
     (台帳 OC48-M1。同種の指摘に OC45-L4 がある)。
  ...
  /* 九星気学:月命星(1〜9)を間合いに写す。根拠は月命星の項目に出る
     ...
     三碧=自分から先に声をかけて懐へ入る→近づく/四緑=間に立って近さを取り持ち直す→変える/
     五黄=寄る前に場の全体を眺める→見渡す/六白=一定の隔たりを置いて向き合う→見渡す/
     七赤=言葉を交わしながら親しくなる→近づく/八白=間合いを見定めてから関わる→見渡す/
     九紫=立つ場所が移るたびに近さも入れ替わる→変える */
