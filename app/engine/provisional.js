...
(function (root, factory) {
  ...
  var DAY_KANSHI_NOTE =
    ...
    /* cycle-0065(台帳 OC62-L2):名指しの前に同じ見出しの言葉を繰り返さない書き方へ。
       official.js の同名の定数と一字一句同じにすること(OC62-5 が突き合わせる) */
    ...
    return {
      ...
      items: [
        { label: '太陽星座', value: name,
          /* cycle-0065(台帳 OC58-L1):求め方の説明は about が持つ。ここは境目の日の断りだけ */
          note: '境目の日の生まれの方は、隣の星座として読まれることもあるでしょう。' },
  ...
  function sukuyo(b) {
    ...
    return {
      ...
      /* cycle-0064(監査 R6):以前は「月の巡りと人との相性」だった。同じ画面の
         「二十七のうちの何番目か」で「二人の隔たりを数えることはしていない」と述べる以上、
      ...
      items: [
        ...
        { label: '巡りの位置', value: (i + 1) + ' / 27',
          note: '人との間柄を数えるための番号ではなく、二十七を並べた輪の上であなたの居場所がどこかを指すものです。' +
                'このアプリは二人ぶんの生まれた日を同時に受け取る欄を持たないので、二人の隔たりを数えることはしていません。' +
