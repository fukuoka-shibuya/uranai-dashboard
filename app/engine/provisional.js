...
(function (root, factory) {
  ...
  function sanmei(b) {
    ...
    return {
      ...
      summary: '土台となる日の干支は「' + KAN[kanIdx] + SHI[shiIdx] + '」、中心の星は「' +
               MAIN_STAR[kanIdx] + '」と出ています。この二文字を軸に、暮らしの手触りを' +
    ...
    return {
      ...
      items: [
        ...
        { label: '星の色', value: KYUSEI_IRO[h - 1],
          note: 'この色は生まれた年から見た自分の星が決まればひとりでに決まります。あなたの場合にどう出やすいかは、上の「生まれた年から見た自分の星」に書いてあります。色そのものが人の性質を言い表しているわけではありません。' },
        { label: '定位の方角', value: KYUSEI_HOUI[h - 1],
          note: 'この方角も生まれた年から見た自分の星と一対一で決まります。あなたの場合にどう出やすいかは、上の「生まれた年から見た自分の星」に書いてあります。方角そのものに良し悪しがあるわけではありません。' }
      ]
    };
  }
    ...
    return {
      ...
      items: [
        { label: '太陽星座', value: name,
          note: '生まれた日の空で太陽が置かれていた場所として読む部分です。境目の日の生まれの方は、隣の星座として読まれることもあるでしょう。' },
  ...
  var SHUKU_KEITOU_NOTE = {
    '和': '人と向き合う場では、相手に合わせて場をなだらかにする調子が出やすいと読み取れます。',
    '栄': '人の集まる場では、前に出て輪を広げる調子が出やすいと読み取れます。',
    '静': '人と交わる場では、一歩引いて全体を眺める調子が出やすいと読み取れます。'
  };
    ...
    return {
      ...
      items: [
        ...
        { label: '生まれの宿', value: SHUKU[i],
          note: '人とどう向き合いやすいかは、この宿を出発点にして読み解いていきます。あなたの場合にどんな調子が出やすいかは、下の「人との付き合い方の型」に書いてあります。' },
        { label: '宿の系統', value: kei + 'の型', note: SHUKU_KEITOU_NOTE[kei] },
        { label: '巡りの位置', value: (i + 1) + ' / 27',
          note: '相手との間柄は、二十七の輪の上で二人がどれだけ離れているかを数えて読みます。あなたの番号が分かると、相手との巡り合わせをたどる手がかりになります。' },
        { label: '人との調子', value: ['合わせやすい', '刺激になりやすい', '学び合いやすい'][i % 3],
          note: '相手と向き合うときに流れやすい調子です。合う合わないを決めつけるものではないと考えています。' }
      ]
    };
  }
